...
# rebase-merge state blocks every subsequent rebase attempt. This step only
# ever needs the latest origin/main plus one new commit, not to preserve
# any local history, so resetting to origin/main is both simpler and
# self-healing against any stuck local state.
